# -*- coding: utf-8 -*-
"""
Created on Sun Jun 16 13:06:06 2024
...
if __name__ == '__main__':
    paralelizacion = Paralelizacion(dimensiones=2, lim_inf_global=-30.0, lim_sup_global=30.0, num_subregiones=6, funcion='cuadratica')
